...
describe('SmsService', () => {
  ...
  describe('sendWithTwilio', () => {
    it('should throw error when Twilio client not initialized', async () => {
      ...
      await expect((serviceWithoutTwilio as any).sendWithTwilio(message))
    ...
    it('should throw error when phone number not configured', async () => {
      ...
      await expect((serviceWithoutPhone as any).sendWithTwilio(message))
  ...
  describe('sendWithVonage', () => {
    it('should throw error when Vonage client not initialized', async () => {
      ...
      await expect((serviceWithoutVonage as any).sendWithVonage(message))
  ...
  describe('getDeliveryStatus', () => {
    ...
    it('should throw error for unsupported provider', async () => {
      await expect(service.getDeliveryStatus('MSG123', 'unsupported' as any))
