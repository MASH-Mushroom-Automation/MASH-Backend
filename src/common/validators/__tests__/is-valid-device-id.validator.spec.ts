...
describe('IsValidDeviceId Validator', () => {
  ...
  describe('Invalid Device IDs - MAC Address Issues', () => {
    ...
    it.skip('should reject MAC address with mixed separators', async () => {
      // Note: Current regex implementation uses alternation which technically allows this.
      // This is a known limitation. Strict validation would require more complex regex.
      const dto = new TestDeviceDto();
      dto.deviceId = '00:1B-44:11-3A:B7';
